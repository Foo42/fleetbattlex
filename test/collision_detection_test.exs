defmodule Fleetbattlex.CollisionsTests do
  use ExUnit.Case
  ...
  test "non-overlapping vectors do not collide" do
    ...
    assert Collisions.detected?(a,b) == false
  end
  ...
  test "crossing vectors collide" do
    ...
    assert Collisions.detected?(a,b) == true
  end
  ...
  test "size of items increases their intersection" do
    ...
    assert Collisions.detected?(a,b) == false
    assert Collisions.detected?(a,bLarge) == true
  end
  ...
  test "detect_all returns a list of colliding vector combinations when given a list of vectors" do
    ...
    collisions = Collisions.detect_all [north,east,diagonal_intecepter]
